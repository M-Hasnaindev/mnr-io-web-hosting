...
?>
    <li><a class="nav-link scrollto" href="logout.php">signup</a></li>
...
?>
    <img src="img/photos/hh.jpg" 
    alt="Hasnain" class="img-fluid rounded-circle mb-2" 
    width="128" height="128" />
