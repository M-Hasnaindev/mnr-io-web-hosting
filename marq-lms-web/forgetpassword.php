      ...
      <div class="container-fluid">
          <div class="row">
              <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 pt-2 pb-2">
                ...
                <p class="float-right">
                    <a class="float-right" href="index.php"  style="color: #7B96D4;">
          ...
          <div class="row">
              <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 sidepic">
                <div class="d-flex justify-content-center border border-light p-5 ">
                    <img src="signin/3.png" class="img-fluid" alt="">              
                  </div>
              </div>
              <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 signinpage3 ">
                    ...
                    <div class="main-div2">
                        <div class="panel2"> 
                       <p><a href="signin.php" style="float: right; text-decoration: none; font-weight: bold; font-size: 16px;"><i class="fa fa-arrow-circle-o-left fa-lg" aria-hidden="true"></i></a></p>
                       ...
                       <form id="newpsd">
                           ...
                           <div class="form-group input-group">
                            ...
                            <input name="" class="form-control" placeholder="@kfueit.edu.pk" type="email" required>
                        </div>
